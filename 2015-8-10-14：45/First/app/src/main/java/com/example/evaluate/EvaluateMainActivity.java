...
public class EvaluateMainActivity extends Activity {
        ...
        try {
            ...
            temp = ea.GetAccount(obj, mcontext, new EvaluateAccounts.getAccount() {
                ...
                public void onSuccess1(List<Map<String, Object>> as, long[] a) {
                    if (as != null) {
                        one_key_evaluate_button.setFocusable(true);
                        ...
                        one_key_evaluate_button.setFocusable(false);
                        Toast.makeText(EvaluateMainActivity.this,"没有帮客需要评价", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } catch (Exception e) {
    ...
    void init() {
        ...
        one_key_evaluate_button.setOnClickListener(new View.OnClickListener() {
            @Override
