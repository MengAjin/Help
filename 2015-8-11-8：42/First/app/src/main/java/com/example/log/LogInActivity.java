...
import com.example.me.ImageUtil;
...
public class LogInActivity extends Activity {
    ...
    private TextView account, password, signup, find_pdw;
    ...
    private void init() {
        ...
        find_pdw = (TextView) findViewById(R.id.editText);
        find_pdw.setOnClickListener(new find_pwd_listener());
    }
        ...
        if(!name.equals("")) {
            ...
            JsonRequest<JSONObject> jsonRequest = new JsonObjectRequest(Request.Method.POST,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (response.toString().contains("status")) {//response.getInt("status") == 500
    ...
    /*忘记密码的监听事件*/
    private class find_pwd_listener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
