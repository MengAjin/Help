...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withLocation(current_location);
        PlanNode enNode = PlanNode.withLocation(new LatLng(23.072552,113.395988));
        //PlanNode enNode = PlanNode.withCityNameAndPlaceName("广州", editEn.getText().toString());//这里要换
