...
public class event {
    ...
    public int getLauncher_id() throws JSONException {
        return jsonObject.getInt("launcher_id");
    }
    public String getLauncher() throws JSONException {
        return jsonObject.getString("launcher");
    }
