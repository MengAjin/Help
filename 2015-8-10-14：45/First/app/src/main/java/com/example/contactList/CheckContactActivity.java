...
//删除按钮的点击事件函数
    private class delete_listener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            //弹出对话框，询问是否确定添加为好友
            AlertDialog.Builder dialog = new AlertDialog.Builder(CheckContactActivity.this);
                                ...
                                public void onResponse(JSONObject jsonObject1) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObject1.getInt("status") == 200) {
                                            ...
                                            Toast.makeText(CheckContactActivity.this, "delete success", Toast.LENGTH_SHORT).show();
                                            //写入本地数据库
...
//                                            mIntent.putExtra("nickname", add_nickname);
                                          ...
                                          //  CheckContactActivity.this.setResult(1, mIntent);
                                            ...
                                            Toast.makeText(CheckContactActivity.this, "delete failed", Toast.LENGTH_SHORT).show();
                                        }
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            //添加请求失败
                            Toast.makeText(CheckContactActivity.this, "service connection failed", Toast.LENGTH_SHORT).show();
